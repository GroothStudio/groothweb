...
export const GroothStudioIntro = () => {
  return (
      <FadeContent blur={true} duration={700} easing="ease-out" initialOpacity={0} className="w-[100vw] h-[100vh] max-md:h-[540px] max-lg:h-[60vh] max-xl:h-[48vh] flex items-center justify-center">
        <BorderBox className="w-[93%] h-[93vh] max-md:h-[480px] max-lg:h-[55vh] max-xl:h-[40vh] relative">
